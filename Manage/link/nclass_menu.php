...
<thead>
        <tr>
          <td height="25" colspan="2" align="center" background="../images/bg.gif">添加菜单</td>
        </tr>
      </thead>
    <tr>
      ...
      <tr>
        ...
        <option value="0">-----顶级分类-----</option>
            <?php
			    $class_arr=getClassArray('g_nclass_menu');
  ...
  <?php
    ...
    <table width="600" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#b0c4de">
      <thead>
        <tr>
          <td height="25" colspan="2" align="center" background="../images/bg.gif">修改菜单</td>
        </tr>
      </thead>
      <tr>
        <td height="25" align="right" bgcolor="#FFFFFF">菜单名称：</td>
...
<?php
    ...
    <tr>
      <td width="54" align="center" background="../images/bg.gif" >ID</td>
      <td width="222" height="25" align="center" background="../images/bg.gif" >菜单名称</td>
      <td width="210" align="center" background="../images/bg.gif">URL</td>
      <td width="108" height="25" align="center" background="../images/bg.gif">排序</td>
      <td width="200" height="25" align="center" background="../images/bg.gif">操作</td>
      </tr>
      <?php nclass_arr(0,0);?>
</table>
<?php
