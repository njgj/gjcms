...
<thead>
        <tr>
          <td height="25" colspan="2" align="center" background="../images/bg.gif">添加用户组</td>
        </tr>
    </thead>
    <tr>
  ...
  <?php
    ...
    <table width="600" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#b0c4de">
      <thead>
        <tr>
          <td height="25" colspan="2" align="center" background="../images/bg.gif">修改用户组</td>
        </tr>
      </thead>
      <tr>
        <td height="25" align="right" bgcolor="#FFFFFF">用户组名称：</td>
...
<?php
	...
	case '':
		?>
    <table width="674" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#b0c4de">
    <tr>
      <td width="44" align="center" background="../images/bg.gif" >ID</td>
      <td width="222" height="25" align="center" background="../images/bg.gif" >用户组名称</td>
      <td width="156" align="center" background="../images/bg.gif">备注</td>
      <td width="117" height="25" align="center" background="../images/bg.gif">排序</td>
      <td width="129" height="25" align="center" background="../images/bg.gif">操作</td>
      </tr>
      <?php 
    ...
    <tr>
      ...
      <td height="25" align="center" bgcolor="#FFFFFF"><img src="../images/write.gif" width="9" height="9" />[<a href="?Action=edit&groupid=<?php echo $row['groupid'] ?>">修改</a>]&nbsp;&nbsp;<img src="../images/write.gif" width="9" height="9" />[<a href="javascript:void(0);" onClick="newwin('user_group_qx.php?groupid=<?php echo $row['groupid']?>',200,400)">权限分配</a>]</td>
    </tr>
    <?php }?>
</table>
<?php
