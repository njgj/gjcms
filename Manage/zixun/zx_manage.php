...
<body>
<form id="form1" name="form1" method="get" action="zx_manage.php">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30" background="../images/tab_05.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="12" height="30"><img src="../images/tab_03.gif" width="12" height="30" /></td>
            <td width="838"><img src="../images/tb.gif" width="16" height="16" align="absmiddle" />&nbsp;你当前的位置：咨询管理</td>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CDEAFB">
                ...
                <tr>
                  <td width="9%" height="25" align="center" bgcolor="#FFFFFF">发送用户</td>
                  <td width="22%" bgcolor="#FFFFFF"><input type="text" name="username" id="username" /></td>
                  <td width="11%" align="center" bgcolor="#FFFFFF">接收用户</td>
                  <td width="23%" bgcolor="#FFFFFF"><input type="text" name="tousername" id="tousername" /></td>
                  <td width="23%" align="center" bgcolor="#FFFFFF">状态</td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#b5d6e6">
  <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#c1ebff'"  onmouseout="this.style.backgroundColor='#FFFFFF'">
    ...
    <td align="center" background="../images/bg.gif" bgcolor="#FFFFFF">发送用户</td>
  ...
  <?php
			$sql="select * from g_zixun where id>0";
  ...
  <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#c1ebff'"  onmouseout="this.style.backgroundColor='#FFFFFF'">
    ...
    <td align="center"><a href="javascript:void(0);" onClick="newwin('../user/user_detail.php?userid=<?php echo $row['userid'] ?>',500,480)"><?php echo getUserName($row['userid']) ?></a></td>
