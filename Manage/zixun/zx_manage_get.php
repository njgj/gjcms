...
if($Action=='del' && chk_user('g_zixun',$id,'touserid')){	
    ...
    <tr>
      <td height="30" background="../images/tab_05.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="838"><img src="../images/tb.gif" width="16" height="16" align="absmiddle" />&nbsp;你当前的位置：我收到的咨询</td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#b5d6e6">
  ...
  <?php
			$sql="select * from g_zixun where touserid=".$_SESSION['userid'];
  ...
  <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#c1ebff'"  onmouseout="this.style.backgroundColor='#FFFFFF'">
    ...
    <td align="center"><a href="javascript:void(0);" onClick="newwin('../user/user_detail.php?userid=<?php echo $row['touserid'] ?>',500,480)"><?php echo getUserName($row['userid']) ?></a></td>
