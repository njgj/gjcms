...
switch($_GET['Action']){
	...
	case 'add':
		?>
<form action="?Action=act_add" method="post" id="myform">
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#b0c4de">
<thead>
        <tr>
          <td height="25" colspan="3" align="center" background="../images/bg.gif">添加栏目</td>
        </tr>
      </thead>
    <tr>
      ...
      <td width="391" rowspan="3" align="center" bgcolor="#FFFFFF"><img src="../../uploadfile/images/<?php echo $imgurl; ?>" onerror="this.src='../images/no_pic.gif'" id="img" height="120" onclick="window.open(this.src)" style="cursor:hand"/>
    ...
    <iframe frameborder="0" scrolling="no" src="../../include/upload.php?path=images" width="100%" height="25"></iframe></td>
      ...
      <tr>
        ...
        <option value="0">-----顶级栏目-----</option>
            <?php
			    $class_arr=getClassArray('g_aboutus');
  ...
  <?php
	...
	if($row){
	?>
   <form action="?Action=act_edit" method="post" id="myform">
    <table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#b0c4de">
      <thead>
        <tr>
          <td height="25" colspan="3" align="center" background="../images/bg.gif">修改栏目</td>
        </tr>
      </thead>
      <tr>
        <td width="100" height="25" align="right" bgcolor="#FFFFFF">栏目名称：</td>
    ...
    <tr>
      ...
      <td width="287" height="25" align="center" background="../images/bg.gif" >栏目名称</td>
      <td width="82" height="25" align="center" background="../images/bg.gif">排序</td>
